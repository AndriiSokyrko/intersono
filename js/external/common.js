...
$(document).ready(function(){
    $('.header-menu-li-multy').on('click',function(){
        $(this).find('ul').slideToggle("slow" );
    });
    $('.icomoon-search').on('click',function(){
        $(this).next('input').slideToggle("slow" );
    })
     $('.icomoon-paragraph-justify').on('click',function(){
        $('.header .header-menu-bg').slideToggle("slow" );
    })
 $('.menu-list-last').on('click',function(){
     $('.menu-list-last').append('<ul class="dinamicMenu">') ;
     var liHide = $('li.menu-li-hide');
alert(liHide.length);
     $(liHide).each(function() {
         var elm= $(this).html();
             $('.dinamicMenu').append('<li>'+elm+'</li>');
         });
     $('.menu-list-last').append('</ul>') ;

     $('.dinamicMenu .menu-li-hide').css({
         'display':'block',
         'width':'auto',
         'position':'absolute',
         'top':'26px'
